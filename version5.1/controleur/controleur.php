...
function ctlValiderFormation($dateFormation, $heureFormation, $nomDuMecanicienPourForm){
	validerFormation($dateFormation, $heureFormation, $nomDuMecanicienPourForm);
	echo 'La formation du '.$dateFormation.' à '.$heureFormation. ' du mecanicien '.$nomDuMecanicienPourForm.' est confirmée';
	$nomMeca = recupererMeca();
	afficherMecanicien($nomMeca);
}

function ctlAffPlanning($nomDuMecanicienAffPlanning){
	$listedesinter = affPlanning();
	afficherlesinter($listedesinter, $nomDuMecanicienAffPlanning);
	$nomMeca = recupererMeca();
	afficherMecanicien($nomMeca);
}
