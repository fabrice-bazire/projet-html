		...
		<form method="post" action="garage.php">
			<fieldset>
				...
				<p>
					...
					<input type="text" name="nomDuMecanicien" value='<?php echo "$mecanoselect"; ?>' size="15" maxlength="15" readonly/>
				</p>
				<p>
				...
				<p>
					<label for="typeInter">Type d'intervention:</label> <?php echo "$choixInter"; ?>
				</p>
				<p>
